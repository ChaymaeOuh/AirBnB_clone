...
"""
    Implementation of all the test for the base_model
"""
...
class TestBase(unittest.TestCase):
    ...
    def test_name(self):
        ...
        self.assertEqual("First Model", self.my_model.name)
    ...
    def test_save(self):
        """
        Checks that the dates differ in the updated_at
        attribute after updating the instance.
        """
